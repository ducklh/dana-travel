...
module.exports = exports = async (connection) => {
  ...
  const tour = await insert('category')
    .given({
      status: 1,
      include_in_nav: 1
    })
  ...
  await insert('category_description')
    .given({
      category_description_category_id: tour.insertId,
      name: 'Tour',
      url_key: 'Tour',
      meta_title: 'Tour',
  ...
  const hotel = await insert('category')
    .given({
      status: 1,
      include_in_nav: 1
    })
  ...
  await insert('category_description')
    .given({
      category_description_category_id: hotel.insertId,
      name: 'Hotel',
      url_key: 'Hotel',
      meta_title: 'Hotel',
